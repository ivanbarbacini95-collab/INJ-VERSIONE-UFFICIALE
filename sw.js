const CACHE_NAME = 'inj-node-v15.99.78-shell';
const APP_SHELL = [
  './',
  './index.html',
  './viewport.css?v=15.99.78',
  './viewport.js?v=15.99.78',
  './style.css?v=15.99.78',
  './app.js?v=15.99.78',
  './live-charts.html',
  './live-charts.css?v=15.99.78',
  './live-charts.js',
  './order-book.html',
  './order-book.css?v=15.99.78',
  './order-book.js',
  './command-center.html',
  './command-center.css?v=15.99.78',
  './command-center.js',
  './treasury.html',
  './treasury.css?v=15.99.78',
