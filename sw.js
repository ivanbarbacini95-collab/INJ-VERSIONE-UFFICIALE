const CACHE_NAME = 'inj-node-v15.99.77-shell';
const APP_SHELL = [
  './',
  './index.html',
  './viewport.css?v=15.99.77',
  './viewport.js?v=15.99.77',
  './style.css?v=15.99.77',
  './app.js?v=15.99.77',
  './live-charts.html',
  './live-charts.css?v=15.99.77',
  './live-charts.js',
  './order-book.html',
  './order-book.css?v=15.99.77',
  './order-book.js',
  './command-center.html',
  './command-center.css?v=15.99.77',
  './command-center.js',
  './treasury.html',
  './treasury.css?v=15.99.77',
