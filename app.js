...
function enterLiveChartsFromGate() {
  ...
  window.location.assign('./live-charts.html?v=15.99.78');
}
...
function enterOrderBookFromGate() {
  ...
  window.location.assign('./order-book.html?v=15.99.78');
}
...
function enterCommandCenterFromGate() {
  ...
  setHeaderMenuOpen(false);
  setSearchOpen(false);
  window.location.assign(`./command-center.html?wallet=${encodeURIComponent(wallet.address)}&v=15.99.78`);
}
...
function registerPwa() {
  if ('serviceWorker' in navigator) {
    window.addEventListener('load', () => navigator.serviceWorker.register('./sw.js?v=15.99.78').catch(() => {}), { once: true });
  }
  updateInstallUi();
}
